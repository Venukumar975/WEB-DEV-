...
`);
  ...
  // for section - 4 execute the CRUD operations
  await db.exec(query)

  // Display data from the table after performing CRUD Operations
  const response = await db.query('SELECT id , brand ,condition , year , price , sold FROM cars');
